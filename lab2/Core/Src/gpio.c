...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_D1_Pin|SPI_SW_SS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, R1_Pin|R2_Pin|R3_Pin|R4_Pin
                          |SW_CS_Pin|SW_SDA_Pin|SW_SCK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_D1_Pin SPI_SW_SS_Pin */
  GPIO_InitStruct.Pin = LED_D1_Pin|SPI_SW_SS_Pin;
